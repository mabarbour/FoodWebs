...
The figures below are the results of three separate simulations, where the conversion efficiency of the consumer was increased from 0.3 to 0.7 and all other parameters were held constant.
...
xlab="R",main="Predator efficiency = 0.7")
...
Below is a bifurcation plot, showing how the dynamics of the system changes along a continuous gradient of conversion efficiency.  Note that at high conversion efficiency, the consumers go extinct, but the stability of the system quickly changes over a short parameter range.
```{r eval=TRUE, echo=FALSE}
par(mfrow=c(1,2))
...
param.seq <- seq(0.1,1,length=50) # choose range of parameters
e <- 0.1
